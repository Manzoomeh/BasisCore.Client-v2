...
export default class BarChart {
  ...
  applyFeatures() {
    ...
    const { chartTitle, axisLabel, hover, grid, group, x, legend, onLabelClick } = this.chartSetting;
    ...
    if (axisLabel) {
      ...
      const xAxis = this.chart.append("g")
        ...
        .call(d3.axisBottom(x ? this.groupScale : this.xScale).tickSizeOuter(0))
