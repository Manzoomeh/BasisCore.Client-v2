import layout from "./assets/password-layout.html";
import Question from "../../question/Question";
import TextBaseType from "../text-area/TextBaseType";
import { IPartCollection } from "../../IAnswerSchema";
import { IQuestionPart } from "../../IQuestionSchema";

export default class PasswordType extends TextBaseType<HTMLInputElement> {
  private readonly _iconContainer: HTMLSpanElement;
  ...
  private showPass(icon: HTMLElement) {
