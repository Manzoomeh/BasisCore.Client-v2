...
export default class AutoCompleteSingleType extends AutoCompleteType {
  ...
  private onShowPopUpBtnClick(e: MouseEvent) {
    ...
    if (this._btn.getAttribute("data-bc-btn") === "add") {
      ...
      this._btn.innerHTML = `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-sys-plus-icon="" d="M8.4 0H5.6V5.6H0V8.4H5.6V14H8.4V8.4H14V5.6H8.4V0Z" fill="#004B85"/></svg>`;
    }
  }
